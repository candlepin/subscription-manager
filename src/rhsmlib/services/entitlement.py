...
class EntitlementService(object):
    ...
    def remove_all_pools(self):
        """
        Try to remove all pools
    ...
    def remove_pools_by_ids(self, pool_ids):
        """
        Try to remove pool by IDs
    ...
    def remove_pools_by_serials(self, serials):
        """
