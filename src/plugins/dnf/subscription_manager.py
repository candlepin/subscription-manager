...
skew_clock_warning = _(
    """
This system has skewed clock. Time difference with server is {time_drift} seconds. \
Please check your clock settings. Otherwise, the subscription-manager may not work correctly.
"""
)
...
class SubscriptionManager(dnf.Plugin):
    ...
    def _warn_skew_clock():
        ...
        if time_drift is None:
            return
        elif time_drift > datetime.timedelta(minutes=1):
