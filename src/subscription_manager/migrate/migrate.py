...
class MigrationEngine(object):
    ...
    def add_parser_options(self):
        ...
        self.parser.add_option("--redhat-username",
            help=_("specify the redhat username"))
    ...
    def get_auth(self):
        if self.options.redhat_username:
                    rh_pass = self.options.redhat_password or getpass.getpass()
                    self.rhncreds = UserCredentials(self.options.redhat_username, rh_pass)
        else:
