        ...
        try:
            ...
            if self.cp.supports_resource('environments'):
                ...
                if len(environments):
                    ...
                    print _("Server supports environments, but none are available.")
            else:
