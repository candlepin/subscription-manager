...
class CliCommand(AbstractCLICommand):
    ...
    def main(self, args=None):
        ...
        if rhsm.config.in_container():
            system_exit(os.EX_CONFIG, _("subscription-manager is operating in container mode. Use your host system to manage subscriptions.\n"))
            ...
            try:
                if self.options.all:
                    ...
                    if self.options.pool_ids:
                        removed_pools, unremoved_pools, removed_serials = ent_service.remove_entitlements_by_pool_ids(self.options.pool_ids)
