...
class RemoveCommand(CliCommand):
    ...
    def _do_command(self):
        ...
        if self.is_registered():
            ...
            try:
                if self.options.all:
                    total = ent_service.remove_all_pools()
                    ...
                    if self.options.pool_ids:
                        removed_pools, unremoved_pools, removed_serials = ent_service.remove_pools_by_ids(self.options.pool_ids)
                    ...
                    if self.options.serials:
                        ...
                        _removed_serials, unremoved_serials = ent_service.remove_pools_by_serials(serials_to_remove)
