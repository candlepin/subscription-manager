...
class ReviewSubscriptionPage:
    def __init__(self):
        ...
        self.reviewSubscriptionXml.signal_autoconnect(dic)

        #self.mainWin = self.reviewSubscriptionXml.get_widget("dialog_updates")
    ...
    def __init__(self):
        ...
        self.xml.signal_autoconnect (
            {"onDruidCancel" : self.onDruidCancel,
              ...
              #"on_button1_clicked" : self.onDruidImport,
        })
