...
class EmptyListingTests(unittest.TestCase):
    def test(self):
        ...
        self.assertEqual(listing_file.get_releases(), [])
...
class TestEmptyListing(ListingTests):
    ...
    def testEmpty(self):
        self.assertEqual([], self.listing.get_releases())
...
class TestOneRelease(ListingTests):
    ...
    def testOneRelease(self):
        self.assertEqual(["6"], self.listing.get_releases())
...
class TestMultipleReleases(ListingTests):
    ...
    def testMultipleReleases(self):
        self.assertEqual(["6", "7", "8"], self.listing.get_releases())
...
class TestMultipleNonInt(ListingTests):
    ...
    def testMultipleReleasesNonInt(self):
        self.assertEqual(["6", "6Awesome", "7Amazing", "8"], self.listing.get_releases())
