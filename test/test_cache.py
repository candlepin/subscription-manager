...
class TestCryptographicCapabilitiesCache(SubManFixture):
    def setUp(self):
        ...
        self.crypto_caps = CryptographicCapabilities(
            key_algorithms=self.key_algs, signature_algorithms=self.sig_algs
        )
        self.crypto_cache = CryptographicCapabilitiesCache(self.crypto_caps)
    ...
    def test_has_changed_current_to_legacy(self):
        ...
        legacy_cache = CryptographicCapabilitiesCache(
            CryptographicCapabilities(key_algorithms=None, signature_algorithms=None)
        )
