...
_rhn-migrate-classic-to-rhsm()
{
	...
	opts="-h --help --environment -f --force -g --gui -n --no-auto --no-proxy --org -s --service-level --legacy-user --legacy-password --destination-url --destination-user --destination-password"
