...
class PageStatus {
    ...
    commit_own() {
        console.log("COMMIT", this.pending_own);
        this.set_own(this.pending_own);
    }

    add_own(status) {
        // This should do some better defined merging
        this.pending_own = status;
    }
